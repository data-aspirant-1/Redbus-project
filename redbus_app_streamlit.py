...
df = df.dropna(subset=["Seats_available", "Price", "Ratings"])
...
# Bus Details Page
    ...
    selected_bus_type = st.sidebar.selectbox("Bus Type", options=[""] + list(bus_types), index=0)
    ...
    selected_start_time = st.sidebar.selectbox("Departure Time", options=[""] + list(start_times), index=0)
    ...
    if selected_bus_type and selected_start_time:
        filter_data = filter_routes_by_bus_type[
            ...
            (filter_routes_by_bus_type["Ratings"].between(min_rating, max_rating)) &
    ...
    if not filter_data.empty:
        ...
        st.dataframe(filter_data[["State","Bus_name","Bus_type","Departure_time","Arrival_time","Total_duration","Price","Seats_available","Ratings","Route_name","Route_link"]])
        ...
        if selected_bus_id_1 and selected_bus_id_2:
            try:
                ...
                comparison_data = {
                    ...
                    "Bus 1": [bus_1["Route_name"], bus_1["Bus_name"], bus_1["Bus_type"], bus_1["Departure_time"], bus_1["Arrival_time"], bus_1["Price"], bus_1["Ratings"], bus_1["Seats_available"]],
                    "Bus 2": [bus_2["Route_name"], bus_2["Bus_name"], bus_2["Bus_type"], bus_2["Departure_time"], bus_2["Arrival_time"], bus_2["Price"], bus_2["Ratings"], bus_2["Seats_available"]]
                }
